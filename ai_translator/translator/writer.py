...
class Writer:
    ...
    def save_translated_book(self, book: Book, output_file_format: str, target_language: str, translation_style: str, translated_pages: int = None):
        LOG.debug(f"save_translated_book called with: output_file_format={output_file_format}, target_language={target_language}, translation_style={translation_style}, translated_pages={translated_pages}")
